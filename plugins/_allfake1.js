...
handler.all = async function (m) {
    ...
    let uptime = clockString(_uptime)
       ...
       global.fetch = import('node-fetch')
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '6282281657946@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'gendonmenjeng@mail.com', true],
         [owner[1], await this.getName(owner[1] + '6289514509029@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'gendonmenjeng@mail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://bit.ly/AboutKyyFC",					
				}
			}
		}
		global.fakeig = {
