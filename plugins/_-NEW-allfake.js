...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '6282281657946@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'gendonmenjeng@gmail.com', true],
         [owner[1], await conn.getName(owner[1] + '6289514509029@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'gendonmenjeng@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://github.com/diki6969",					
				}
			}
		}
				global.fakeig = {
